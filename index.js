...
console.log(`The first artist in the array is`,artists[0].name);
...
console.log(artists[9].name,`'s name has been corrected.`)
...
console.log('getArtistByIndex(), task 3:', getArtistByIndex(artists, 4));
...
console.log(`listOfNames(), task 4:`, listOfNames(artists));
...
console.log(`removeArtist(), task 5:`, removeArtist(artists, 0));
...
console.log(`lotsOfArt(), task 7:`, lotsOfArt(artists));
...
console.log(`artistInfo(), task 8: `, artistInfo(artists, `Kahlo`));
...
function artistByCountry(array, string){
  ...
  for(let i=0; i<array.length;i++){
    if(array[i].nationality == string){
      cherryPicked.push(array[i].name);
    }
  }
  return cherryPicked;
}
console.log(`artistsByCountry(), task 9`, artistByCountry(artists, `Spanish`));
